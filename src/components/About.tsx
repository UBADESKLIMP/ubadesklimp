        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              Há mais de 15 anos no mercado, a Ubadesklimp é referência em produtos de limpeza 
              de alta qualidade. Nossa missão é proporcionar ambientes mais limpos e saudáveis 
          ...
          <div className="grid grid-cols-2 gap-6 animate-slide-up">
            {stats.map((stat, index) => (
              <div 
                key={index}
                className="bg-gradient-card p-6 rounded-2xl border border-border text-center hover-lift"
