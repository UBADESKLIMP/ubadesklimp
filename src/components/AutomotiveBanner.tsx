      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative rounded-[20px] animate-fade-in-up">
            ...
            <div
              className={`relative bg-[#0b0d10] rounded-[20px] px-8 md:px-12 py-4 md:py-6 overflow-hidden ${
                ...
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <div className="relative">
                    ...
                    {isExiting && (
                      <div className="absolute bottom-[32%] left-[12%] pointer-events-none">
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(90deg, rgba(30, 144, 255, 0.8), rgba(30, 144, 255, 0.4), transparent)",
                        ...
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(90deg, rgba(30, 144, 255, 0.7), rgba(30, 144, 255, 0.3), transparent)",
                    ...
                    {isHovered && !isShaking && !isExiting && (
                      <div
                        className="absolute top-[38%] right-[10%] w-6 h-3 pointer-events-none z-10 animate-headlight-on"
                        style={{
                  ...
                  <div
                    className={`flex flex-col ${isExiting ? "animate-fade-out-fast" : "animate-fade-in-up"}`}
